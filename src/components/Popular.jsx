...
function Popular() {
  ...
  https://api.themoviedb.org/3/movie/popular?api_key=55b993abee2aac669e1b738919ecdf65&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=${page}`);
